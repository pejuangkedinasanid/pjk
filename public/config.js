// config.js — Supabase & Midtrans credentials untuk halaman HTML di folder public/
// Ini HANYA untuk key yang aman diekspos ke publik (anon key, client key).
// Server Key / Service Role Key JANGAN PERNAH diletakkan di sini.
